...
public class AdminCommentController {
    ...
    public CommentResponseDto getCommentById(@PathVariable @Positive Long adminId,
                                             @PathVariable @Positive Long commentId) {
    ...
    public List<CommentResponseDto> getCommentsByAdmin(@PathVariable @Positive Long adminId,
